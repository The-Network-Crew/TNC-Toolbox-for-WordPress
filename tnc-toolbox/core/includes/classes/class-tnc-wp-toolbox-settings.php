...
class Tnc_Wp_Toolbox_Settings{
    ...
    private function save_settings() {
    	...
    	$api_key_file = WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-api-key';
    	...
    	$username_file = WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-username';
    	...
    	$hostname_file = WP_PLUGIN_DIR . '/tnc-toolbox/assets/server-hostname';
    		...
    		<form method="post">
    			...
    			<table class="form-table">
    				<tr>
    					...
    					<td><input type="text" id="tnc_toolbox_api_key" name="tnc_toolbox_api_key" value="<?php echo esc_attr( file_get_contents( WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-api-key' ) ); ?>" /></td>
    				</tr>
    				<tr>
    					<th scope="row"><label for="tnc_toolbox_username">cPanel Username</label><br><small>Plain-text user, as used to log-in.</small></th>
    					<td><input type="text" id="tnc_toolbox_username" name="tnc_toolbox_username" value="<?php echo esc_attr( file_get_contents( WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-username' ) ); ?>" /></td>
    				</tr>
    				<tr>
    					<th scope="row"><label for="tnc_toolbox_server_hostname">Server Hostname</label><br><small>FQDN of Server, no HTTPS etc.</small></th>
    					<td><input type="text" id="tnc_toolbox_server_hostname" name="tnc_toolbox_server_hostname" value="<?php echo esc_attr( file_get_contents( WP_PLUGIN_DIR . '/tnc-toolbox/assets/server-hostname' ) ); ?>" /></td>
    				</tr>
    			</table>
