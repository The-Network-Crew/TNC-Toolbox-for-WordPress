...
class Tnc_Wp_Toolbox_Run{
	...
	*/
	...
	function nginx_cache_purge() {
	    ...
	    if( is_readable( WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-username' ) ) {
			$cpanel_username = file_get_contents( WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-username' );
	    } else {
	    ...
	    if( is_readable( WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-api-key' ) ) {
			$api_token = file_get_contents( WP_PLUGIN_DIR . '/tnc-toolbox/assets/cpanel-api-key' );
	    } else {
	    ...
	    if( is_readable( WP_PLUGIN_DIR . '/tnc-toolbox/assets/server-hostname' ) ) {
			$server_hostname = file_get_contents( WP_PLUGIN_DIR . '/tnc-toolbox/assets/server-hostname' );
	    } else {
